# -*- coding: utf-8 -*-
"""
Created on Thu Oct 10 09:06:39 2024
...
valor = 'Extracto_IPS_900849021_2024_05.xlsx'

# Usamos una f-string para incluir la lógica de extracción directamente
nueva_cadena = f'{re.search(r"(\d{4}_\d{2})\.xlsx", valor).group(1)}'
...
email = 'angperilla@segurosmundial.com.co'
...
entidad = "Seguros ABC"
fecha_ultimo_dia = '15/04/2024'
fecha_corte = 'Mayo 2024'


resultado_2 = generar_cuerpo_mensaje(entidad, fecha_ultimo_dia, fecha_corte)
print(resultado_2)

extracto_ips_excel = 'Extracto_IPS_900849021_2024_05.xlsx'
