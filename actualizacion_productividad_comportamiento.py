...
duplicados = df_merged[df_merged.duplicated(subset=['llave'], keep=False)]
...
df_merged.to_excel('resultado_productividad.xlsx', index=False, float_format="%.2f")
